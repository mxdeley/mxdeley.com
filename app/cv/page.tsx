  ...
  return (
    <main className="flex min-h-screen flex-col items-center max-w-4xl mx-auto p-20 space-y-10">
      ...
      <div className="flex justify-start w-full text-stone-400">
        <div>
          <h2 className="text-lg font-bold text-stone-50">About</h2>
          <p className="text-sm">
      ...
      <div className="flex justify-start w-full">
        <div className="space-y-2">
          ...
          <div>
            ...
            <h4 className="text-stone-400 text-sm">2022-Current</h4>
          ...
          <div>
            ...
            <h4 className="text-stone-400 text-sm">2021-Current</h4>
            <p className="text-stone-400 text-sm">
          ...
          <div className="max-w-2xl flex flex-col justify-end space-y-2 ">
            <div>
              ...
              <h4 className="text-stone-400 text-sm">2021-2023</h4>
              <p className="text-stone-400 text-sm">
            ...
            <div>
              ...
              <h4 className="text-stone-400 text-sm">2021-2022</h4>
              <p className="text-stone-400 text-sm">
